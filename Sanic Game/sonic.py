...
def main():
    ...
    level = [
        ...
        "PGGGGGGGGGGGG                                                                        E",
        "PPPPPPPPPPPPPP                                                                       E",
        "PPPPPPPPPPPPPP                     GGGGGGGGG                                         E",
        "PPPPPPPPPPPPP                      PPPPPPPPP                                         E",
        "PPPPPPPPPPPP                                                                         E",
        "PPPPPPPPPPP                                                                          E",
        "PPPPPPPPPP                                                                           E",
        "PPPPPPPPPP                         GGGSSSGGG                                         E",
        "PPPPPPPPPPG                       GPPPPPPPPPG                G   G   G    GGGGGGGGGGGP",
        "PPPPPPPPPPPG                     GPPPPPPPPPPPG               P   P   P    PPPPPPPPPPPP",
        "PPPPPPPPPPPPGG                  GPPPPPPPPPPPPPG              P   P   P    PPPPPPPPPPPP",
        "PPPPPPPPPPPPPPG                GPPPPPPPPPPPPPPPG     GGGG    P   P   P    PPPPPPPPPPPP",
        "PPPPPPPPPPPPPPPGGG      GGG   GPPPPPPPPPPPPPPPPPG            P   P   P    PPPPPPPPPPPP",
